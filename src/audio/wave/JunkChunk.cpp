...
bool JunkChunk::Deserialize(BufferParser & bufferParser)
{
  bool return_value {true};

  if (BufferParser::SwapEndian(bufferParser.Peek<std::uint32_t>()) == JunkChunk::CHUNK_ID)
  {
...
bool JunkChunk::Serialize(BufferSerializer & bufferSerializer)
{
